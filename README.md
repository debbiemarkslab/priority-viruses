...
## Overview
Viruses pose a growing threat to human health through their rapid evolutionary rates, high adaptability, and potential for cross-species spillover. Advances in machine learning and the growing availability of sequence data have shown promise for our ability to predict the effects of mutations. Applied to viruses, accurate fitness prediction could revolutionize our ability to forecast viral evolution, and design better vaccines, therapeutics, or viral vectors. However, existing modeling approaches under-perform when applied to viral mutation effect prediction compared to performance on non-viral proteins. To address this, we develop EVEREST, an Evolutionary model of Variant Effect with Reliability ESTimation. EVEREST outperforms existing methods and introduces novel confidence metrics to assess the reliability of predictions and identify when additional sequence or structural data are required. We provide the first large-scale viral mutation effect predictions of more than 400,000 variants across 40 WHO-prioritized pandemic-threat viruses. Despite limited surveillance for many of the high-risk viruses, we demonstrate that most have sufficient data to enable accurate modeling, underscoring the promise of these approaches for pandemic preparedness. 
