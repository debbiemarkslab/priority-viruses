...
This is the official code repository for the paper: ["Variant effect prediction with reliability estimation across priority viruses"](https://github.com/debbiemarkslab/priority-viruses/tree/main/EVEREST_paper.pdf) from the [Marks Lab](https://www.deboramarkslab.com/).
