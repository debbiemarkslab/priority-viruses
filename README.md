...
This is the official code repository for: ["Evaluating variant effect prediction across viruses"](https://www.biorxiv.org/content/10.1101/2025.08.04.668549v3) from the [Marks Lab](https://www.deboramarkslab.com/).
<p align="center">
...
The [forecasting dataset](https://github.com/debbiemarkslab/priority-viruses/tree/main/data/forecasting_dataset/) folder contains a benchmark testing the ability to predict real-world mutation forecasting within 31 phylogenetic clades from H1N1, H3N2, HIV, and SARS-CoV-2. 
...
## Reference
Sarah Gurev*, Noor Youssef*, Navami Jain, Aarushi Mehrotra, Sarrah Rose Mikhail Leung, Abigail Jackson, Debora S. Marks. Evaluating variant effect prediction across viruses. *BioRxiv*, 2026.
